...
export const cases: CaseStudy[] = [
  ...
  },
  {
    ...
    titleZh: "初创品牌首条毛绒产品线",
    summaryEn: "Guiding first-time plush brands from idea to shippable product, with size-tiered MOQs published upfront.",
    summaryZh: "陪伴首次做毛绒的品牌从想法走到可上架，起订量按尺寸分档、公开透明。",
    ...
    scopeEn: [
      ...
      "First-batch planning around published, size-tiered MOQs to de-risk market entry",
      "Retail-ready Amazon FBA packaging and labelling",
    ],
    scopeZh: [
      "基于 brief、参考图或草图做设计开发",
      "按公开的尺寸分档起订量规划首批订单，降低入市风险",
    ...
    solutionEn: [
      ...
      "Compliance guidance from the first sample round, so first production batches ship with the documentation their target market requires",
      "Sample cost deducted from first bulk order to reduce upfront risk",
      "Amazon FBA packaging and labelling checked before shipment, so first orders arrive warehouse-ready",
    ],
    solutionZh: [
      "设计咨询指导版型、材料、特征选择",
      "成本明细与 MOQ、包装档位挂钩，透明化",
      "从首轮打样即介入合规指导，首批大货出货即附目标市场所需文档",
      "样品费从首个大货订单中抵扣，降低前期风险",
      "出货前核验 Amazon FBA 包装与标签，首批到仓即可直接入库",
    ],
    outcomeEn: [
      "Repeat startup clients growing from their first launch batch into significantly larger reorders",
      "Lower barrier for new plush brand category entry",
      "Launch-ready product with first-batch compliance documentation",
    ],
    outcomeZh: [
      "多个从首批订单成长为持续复购、规模显著扩大的初创客户",
      "新品牌切入毛绒品类的门槛更低",
      "首批即带合规文档的上架就绪产品",
    ],
    ...
    metrics: [
      { labelEn: "MOQ", labelZh: "起订量", valueEn: "Size-tiered, 800–3,600 pcs", valueZh: "按尺寸分档 800–3,600 件" },
      { labelEn: "Reorders", labelZh: "复购", valueEn: "Repeat startup clients", valueZh: "初创客户持续复购" },
    ...
    tags: ["Startup", "Transparent MOQ", "DTC"],
  },
  {
